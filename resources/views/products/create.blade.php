                    ...
                    @csrf
                        ...
                        <div class="row">
                            <div class="input-group mb-4 col-lg-6">
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label" for="product_image">{{__('messages.choose_file')}}</label>
                                </div>
                                @error('product_image')
                        ...
                        <div class=" row align-items-center">
                            <div class="form-group col-md-12">
                                <label for="product_name">{{__('messages.product_name')}} <span class="text-danger">*</span></label>
                            ...
                            <div class="form-group col-md-6">
                                <label for="product_garage">{{__('messages.product_garage')}}</label>
                            ...
                            <div class="form-group col-md-6">
                                <label for="product_store">{{__('messages.product_store')}}</label>
                            ...
                            <div class="form-group col-md-6">
                                <label for="buying_date">{{__('messages.buying_date')}}</label>
                            ...
                            <div class="form-group col-md-6">
                                <label for="buying_price">{{__('messages.buying_price')}} <span class="text-danger">*</span></label>
                            ...
                            <div class="form-group col-md-6">
                                <label for="selling_price">{{__('messages.selling_price')}} <span class="text-danger">*</span></label>
                        ...
                        <!-- end: Input Data -->
                        <div class="mt-2">
                            <button type="submit" class="btn btn-primary mr-2">{{__('messages.save')}}</button>
                            <a class="btn bg-danger" href="{{ route('products.index') }}">{{__('messages.cancel')}}</a>
                        </div>
                    </form>
                </div>
            </div>
